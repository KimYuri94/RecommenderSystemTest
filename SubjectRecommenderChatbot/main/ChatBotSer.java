...
class Chatbot extends JFrame {
	...
	Chatbot(){                                                // Layout and Properties defined in Constructer                                         
		...
		f.setTitle("SerendipitousSubjectRecommender");
		f.add(ca);
		f.add(cf);
		ca.setSize(750,710);
		ca.setLocation(15, 1);
	           ...
	           if (key == KeyEvent.VK_ENTER || e.getSource()==b) {
	              String text=cf.getText();
					...
					if((text.contains("SoapUI") && text.contains("what"))||(text.contains("SoapUI") && text.contains("What"))) {                        
						...
						replyMeth("For SoapUI, I recommend: ReasonML, OpenVas, Ruby.");
						
						
					}
					
					else if(text.contains("GPS")) {    
						replyMeth("For GPS, I recommend: Support Vector Machines, Ethical Hacking, Ruby");
						

					}
					else if(text.contains("Crypto Currency")) {    
						
						replyMeth("For Crypto Currency, I recommend: ReasonML, OpenVas, COBOL");
						
					}
					else if(text.contains("QGIS")) {                        
						replyMeth("For QGIS, I recommend: Support Vector Machines, SSH, Ruby");

					}
					else if(text.contains("Computer Networks")) {                        
						replyMeth("For Computer Networks, I recommend: Support Vector Machines, OpenVas, Julia");

					}
					else if(text.contains("UML")) {                        
						replyMeth("For UML, I recommend: Genetic Algorithms, WireShark, COBOL");

					}
					else if(text.contains("Software Architecture")) {                        
						replyMeth("For Software Architecture, I recommend: Support Vector Machines, OpenVas, COBOL");

					}
					else if(text.contains("Docker")) {                        
						replyMeth("For Docker, I recommend: ReasonML, OpenVas, COBOL");

					}
					else if(text.contains("Raspberry Pi")) {                        
						replyMeth("For Raspberry Pi, I recommend: Support Vector Machines, OpenVas, COBOL");

					}
					else if(text.contains("GeoServer")) {                        
						replyMeth("For GeoServer, I recommend: Data Visualization, Ruby, Computer Networks");

					}
					else if(text.contains("Operating System")) {                        
						replyMeth("For Operating System, I recommend: Genetic Algorithms, OpenVas, .Net Framework");

					}
					else if(text.contains("Computer Graphics")) {                        
						replyMeth("For Computer Graphics, I recommend: Genetic Algorithms, COBOL, Software Architecture");

					}
					else if(text.contains("System Analysis")) {                        
						replyMeth("For System Analysis, I recommend: Support Vector Machines, COBOL, OpenVas");

					}
					else if(text.contains("XMPP")) {                        
						replyMeth("For XMPP, I recommend: Chatbot, ECommerce_Frauds, Ruby");

					}
					else if(text.contains("Linux")) {                        
						replyMeth("For Linux, I recommend: Genetic Algorithms, OpenVas, COBOL");

					}
					else if(text.contains("Blockchain Security")) {                        
						replyMeth("For Blockchain Security, I recommend: Support Vector Machines, SoapUI, C");
					}
					else if(text.contains("SSH")) {                        
						replyMeth("For SSH, I recommend: Support Vector Machines, SoapUI, Julia");
					}
					else if(text.contains("Ransomware")) {                        
						replyMeth("For Ransomware, I recommend: Support Vector Machines, SoapUI, Ruby");
					}
					else if(text.contains("Digital Forensics")) {                        
						replyMeth("For Digital Forensics, I recommend: Support Vector Machines, XMPP, Perl");
					}
					else if(text.contains("Ethical Hacking")) {                        
						replyMeth("For Ethical Hacking, I recommend: Big Data, XMPP, Ruby");
					}
					else if(text.contains("Cyber Security Analysis")) {                        
						replyMeth("For Cyber Security Analysis, I recommend: Support Vector Machines, SoapUI, COBOL");
					} 
					else if(text.contains("WireShark")) {                        
						replyMeth("For WireShark, I recommend: Applied_Statistics, SoapUI, Ruby");
					} 
					else if(text.contains("Cyber Warfare")) {                        
						replyMeth("For Cyber Warfare, I recommend: Support Vector Machines, SoapUI, Ruby");
					} 
					else if(text.contains("ECommerce Frauds")) {                        
						replyMeth("For ECommerce Frauds, I recommend: Support Vector Machines, XMPP, Ruby");
					} 
					else if(text.contains("Nmap")) {                        
						replyMeth("For Nmap, I recommend: Support Vector Machines, SoapUI, Ruby");
					} 
					else if(text.contains("OpenVas")) {                        
						replyMeth("For OpenVas, I recommend: Data Analytics, SoapUI, Ruby");
					} 
					else if(text.contains("Neural Network")) {                        
						replyMeth("For Neural Network, I recommend: ECommerce Frauds, Computer Graphics, COBOL");
					} 
					else if(text.contains("Outlier Detection Algorithms")) {                        
						replyMeth("For Outlier Detection Algorithms, I recommend: ECommerce Frauds, Computer Networks, Julia");
					} 
					else if(text.contains("ReasonML")) {                        
						replyMeth("For ReasonML, I recommend: Chatbot, SoapUI, Julia");
					} 
					else if(text.contains("Big Data")) {                        
						replyMeth("For Big Data, I recommend: ECommerce Frauds, Computer Networks, COBOL");
					} 
					
					else if(text.contains("Time Series Analysis")) {                        
						replyMeth("For Time Series Analysis, I recommend: ECommerce Frauds, Computer Networks, Julia");
					} 
					else if(text.contains("Deep Learning")) {                        
						replyMeth("For Deep Learning, I recommend: ECommerce Frauds, XMPP, COBOL");

					}
					else if(text.contains("AI")) {                        
						replyMeth("For AI, I recommend: ECommerce Frauds, XMPP, COBOL");

					}
					else if(text.contains("Support Vector Machines")) {                        
						replyMeth("For Support Vector Machines, I recommend: ECommerce Frauds, Computer Networks, Julia");

					}
					else if(text.contains("Data Visualization")) {                        
						replyMeth("For Data Visualization, I recommend: Cyber Warfare, SoapUI, COBOL");
					}
					else if(text.contains("Data Analytics")) {                        
						replyMeth("For Data Analytics, I recommend: OpenVas, SoapUI, COBOL");
					}
					else if(text.contains("Seaborn")) {                        
						replyMeth("For Seaborn, I recommend: Crypto Currency, Julia, Outlier Detection Algorithms");
					}
					else if(text.contains("Automation")) {                        
						replyMeth("For Automation, I recommend: OpenVas, SoapUI, COBOL");
					}
					else if(text.contains("Applied Statistics")) {                        
						replyMeth("For Applied Statistics, I recommend: ECommerce Frauds, Computer Networks, Perl");
					}
					else if(text.contains("Image Processing")) {                        
						replyMeth("For Image Processing, I recommend: Cyber Warfare, Computer Networks, COBOL");
					} 
					else if(text.contains("Chatbot")) {                        
						replyMeth("For Chatbot, I recommend: ECommerce Frauds, XMPP, Julia ");
					} 
					else if(text.contains("Genetic Algorithms")) {                        
						replyMeth("For Genetic Algorithms, I recommend: ECommerce Frauds, Computer Networks, Julia");
					} 
					else if(text.contains("Tensorflow")) {                        
						replyMeth("For Tensorflow, I recommend: ECommerce Frauds, Computer Graphics, Julia");
					} 
					else if(text.contains("Net Framework")) {                        
						replyMeth("For Net Framework, I recommend: ReasonML, Ransomware, XMPP");
					} 
					else if(text.contains("MATLAB")) {                        
						replyMeth("For MATLAB, I recommend: Support Vector Machines, ECommerce Frauds, Computer Networks");
					} 
					else if(text.contains("Python")) {                        
						replyMeth("For Python, I recommend: ReasonML, OpenVas, SoapUI");
					} 
					else if(text.contains("Rust")) {                        
						replyMeth("For Rust, I recommend: ReasonML, Cyber Warfare, XMPP");
					} 
					else if(text.contains("Julia")) {                        
						replyMeth("For Julia, I recommend: ReasonML, Cyber Security Analysis, Computer Networks");
					} 
					else if(text.contains("JavaScript")) {                        
						replyMeth("For JavaScript, I recommend: ReasonML, OpenVas, SoapUI");
					} 
					else if(text.contains("COBOL")) {                        
						replyMeth("For COBOL, I recommend: Data Visualization, Cyber Security Analysis, Computer Graphics");
					} 
					else if(text.contains("Clojure")) {                        
						replyMeth("For Clojure, I recommend: ReasonML, Cyber Security Analysis, SoapUI");

					}
					else if(text.contentEquals("C")) {                        
						replyMeth("For C, I recommend: ReasonML, Ethical Hacking, SoapUI");
					} 
					
					else if(text.contains("Ruby")) {                        
						replyMeth("For Ruby, I recommend: ReasonML, OpenVas, SoapUI");
					} 
					else if(text.contains("C++")) {                        
						replyMeth("For C++, I recommend: ReasonML, Cyber Warfare, SoapUI");

					}
					
					else if(text.contains("Java")) {                        
						replyMeth("For Java, I recommend: ReasonML, OpenVas, SoapUI");

					}
					else if(text.contains("PHP")) {                        
						replyMeth("For PHP, I recommend: ReasonML, OpenVas, SoapUI");
					}
					else if(text.contains("Perl")) {                        
						replyMeth("For Perl, I recommend: Support Vector Machines, OpenVas, SoapUI");
					}
					else if(text.contains("SQL")) {                        
						replyMeth("For SQL, I recommend: ReasonML, OpenVas, SoapUI");
					}
					else if(text.contains("Prolog")) {                        
						replyMeth("For Prolog, I recommend: ReasonML, Cyber Security Analysis, Computer Networks");
					}
					else if(text.contains("TypeScript")) {                        
						replyMeth("For TypeScript, I recommend: ReasonML, Cyber Warfare, XMPP");
					}
					else if(text.contains("Groovy")) {                        
						replyMeth("For Groovy, I recommend: Time Series Analysis, Nmap, SoapUI");
					} 
...
public class ChatBotSer {                                     //Driver Class
